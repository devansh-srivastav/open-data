...
function CustomStepper(props) {
    ...
    return (
        <div className="stepper-outer" >
            <span className="stepperHr" />
            <svg width="30" height="30" viewBox="0 0 20 20" fill={(pathname == '/login' ) ? "none" : "#5B76FF"} xmlns="http://www.w3.org/2000/svg">
                <circle cx="10" cy="10" r="10" fill={(pathname == '/login' ) ? "black" : "#5B76FF"}/>
                <path d="M11.0358 6.18073V13.75H9.54163V7.90314L7.74658 8.47382V7.29614L10.8749 6.18073H11.0358Z" fill="white" />
            </svg>
            <div className={(pathname != '/login' && pathname != "/") ? " blue-l  slabel" : "black-l slabel"}>Kontaktdaten  <br/>Hinterlassen</div>
            <span className="stepperHr" />
            <svg width="30" height="30" viewBox="0 0 20 20" fill={(pathname != '/login' && pathname != "/data-upload" && pathname=="/data-link-upload") ? "none" : "#5B76FF"} xmlns="http://www.w3.org/2000/svg">
                <circle cx="10" cy="10" r="9.6875" fill={(pathname != '/login' && pathname != "/data-upload" ) ? "black" : "#5B76FF"} stroke="black" stroke-width="0.625" />
            ...
            <div className={(pathname == '/login' || pathname == "/") ? "black-l slabel big-label" : "blue-l slabel big-label"}>Upload-Option <br />auswahlen</div>
            <span className="stepperHr" />
            <svg width="30" height="30" viewBox="0 0 20 20" fill={(pathname == '/login' || pathname == "/") ? "none" : "#5B76FF"} xmlns="http://www.w3.org/2000/svg">
                <circle cx="10" cy="10" r="9.6875" fill="black" stroke="black" stroke-width="0.625" />
            ...
            <div className={(pathname == '/login' || pathname == '/') ? "black-l slabel" : "blue-l slabel"}>Hochladen</div>
            <span className="stepperHr long" />
